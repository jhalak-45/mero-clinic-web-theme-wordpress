<?php get_header(); ?>
<div class="container-fluid" style="background-color: #f0f0f1;">
    <div class="doctor-page container-fluid  mt-0 pb-3 " style="background-color: #f1f1f1;">
        <h4 class=" p-2  text-center servicepage-title ml-2 mt-0 "> Our Doctors</h4>

        <div class="doctors  shadow-sm p-0">
            <?php
            $args = array(
                'post_type' => 'doctor',
                'posts_per_page' => 24,
