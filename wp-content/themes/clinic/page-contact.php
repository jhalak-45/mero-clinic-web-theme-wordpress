...
<div class="container-fluid">
    <h4 class="h4 p-3 text-center servicepage-title">Contact Us</h4>
    <div class="contact row">
        <div class="col-md-6 p-2 " data-aos="fade-left">
            ...
            <div class="address-detail ">
                <div class="cont">
                    ...
                    <div class="detail col-md-6 shadow" data-aos="fade-up-right">
                        ...
                        <p class="text"><?php the_field('contact_number') ?></p>
                ...
                <div class="cont">
                    ...
                    <div class="detail col-md-6 shadow " data-aos="fade-left">
                        ...
                        <p class="text"><?php the_field('email_address') ?></p>
                    ...
                    <div class="detail col-md-6 shadow " data-aos="fade-right">
                        ...
                        <p class="text"><?php the_field('opening_time') ?></p>
            ...
            <div class="map-image p-2 shadow" data-aos="fade-up-right">
                ...
                <img src="<?php the_field('clinic_map__image') ?>">
            </div>
        </div>
    ...
    <div class="map p-2 my-2 shadow" data-aos="fade-down-left">
        ...
        <iframe src="<?php the_field('clinic_google_map_url') ?>" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
        </iframe>
    </div>
